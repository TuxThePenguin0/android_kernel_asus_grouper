...
static char __initdata tegra_edp_vdd_cpu_map[] = {
	...
	0x64, 0x50,
	/*
	 * Start of T30L variant
	 *
	 * Thanks to Hundsbuah@xda for showing
	 * me how to edit this hex table
	 *
	 * Nexus 7 - regulator_mA = 6000 (board-grouper-power.c)
	 *           regulator = regulator_mA/100
	 *           regulator = 60 -> 0x3c (DEC -> HEX)
	 *
	 * temp_zone = celsius
	 * core_cap = mhz/10
	 *
	**/
	/* This is our regulator (<= 0x3c) */
	/* speedo_id,  regulator,  temp_zone,  core0_cap,  core1_cap,  core2_cap,  core3_cap */
	   0x07,       0x3b,       0x17,       0x96,       0x96,       0x96,       0x96,        /* 23 C - 1500 MHz - Cold boot */
	   0x07,       0x3b,       0x2d,       0x96,       0x96,       0x96,       0x96,        /* 45 C - 1500 MHz */
	   0x07,       0x3b,       0x3c,       0x96,       0x96,       0x96,       0x96,        /* 60 C - 1500 MHz */
	   0x07,       0x3b,       0x4b,       0x8c,       0x8c,       0x8c,       0x8c,        /* 75 C - 1400 MHz */
	   0x07,       0x3b,       0x5a,       0x78,       0x78,       0x78,       0x78,        /* 90 C - 1200 MHz */
	/* End of our regulator */
