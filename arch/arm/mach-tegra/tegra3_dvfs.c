...
static struct dvfs cpu_dvfs_table[] = {
	...
	/* Nexus 7 -> check nominal voltage in cpu_speedo_nominal_millivolts[] (tegra3_speedo.c) for determining top slot */
	/* Cpu voltages (mV):         750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887,  900,  912,  916,  925,  937,  950,  962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237 */
	CPU_DVFS("cpu_g",  7, 0, MHZ,   1,   1,   1,   1, 460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  680,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1270, 1270, 1320, 1320, 1400, 1400, 1500),
	CPU_DVFS("cpu_g",  7, 1, MHZ,   1,   1,   1,   1, 480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1300, 1300, 1370, 1370, 1420, 1420, 1500),
	CPU_DVFS("cpu_g",  7, 2, MHZ,   1,   1,   1,   1, 520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1300, 1370, 1370, 1420, 1420, 1500),
	CPU_DVFS("cpu_g",  7, 3, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  910,  910,  910,  910,  910,  910,  910, 1150, 1150, 1230, 1230, 1230, 1300, 1300, 1370, 1370, 1420, 1420, 1500),
	CPU_DVFS("cpu_g",  7, 4, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  940,  940,  940,  940,  940,  940,  940, 1160, 1160, 1300, 1300, 1300, 1370, 1370, 1420, 1420, 1500, 1500),
...
static struct dvfs core_dvfs_table[] = {
	...
	/* Core voltages (mV):		    950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	/* Nexus 7 -> 1/1 - 520 MHz GPU */
	CORE_DVFS("vde",    1, 1, KHZ,   200000, 228000, 275000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 234000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 234000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 234000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 285000, 361000, 416000,  520000,  520000,  520000,  520000),
	...
	/* Core voltages (mV):		    950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	/* Nexus 7 -> 1/1 - 520 MHz GPU */
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 228000, 275000, 361000, 416000,  520000,  520000,  520000,  520000),
